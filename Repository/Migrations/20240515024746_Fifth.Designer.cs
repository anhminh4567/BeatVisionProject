...
namespace Repository.Migrations
{
    ...
    [Migration("20240515024746_Fifth")]
    partial class Fifth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Models.Album", b =>
                {
                    ...
                    b.HasIndex("BannerBlobId")
                        .IsUnique()
                        .HasFilter("[BannerBlobId] IS NOT NULL");
            ...
            modelBuilder.Entity("Shared.Models.Album", b =>
                {
                    b.HasOne("Shared.Models.BlobFileData", "BannerBlobFile")
                        .WithOne()
                        .HasForeignKey("Shared.Models.Album", "BannerBlobId");
            ...
            modelBuilder.Entity("Shared.Models.Track", b =>
                {
                    ...
                    b.HasOne("Shared.Models.BlobFileData", "BannerBlobFile")
                        .WithOne()
                        .HasForeignKey("Shared.Models.Track", "BannerBlobId");
            ...
            modelBuilder.Entity("Shared.Models.UserProfile", b =>
                {
                    b.HasOne("Shared.Models.BlobFileData", "BannerBlobFile")
                        .WithOne()
                        .HasForeignKey("Shared.Models.UserProfile", "BannerBlobId");
